...
class DisplaySettings(private val vsh: Vsh): ISettingsCategories(vsh) {
    ...
    fun mkItemDisplayLayout() : XmbSettingsItem {
        val text = {
                when(vsh.xmbView?.screens?.mainMenu?.layoutMode){
                    XmbLayoutType.PSP -> "Handheld"
                    XmbLayoutType.PS3 -> "TV"
                    XmbLayoutType.PSX -> "Recorder"
                    XmbLayoutType.Bravia -> "TV"
    ...
    override fun createCategory() : XmbSettingsCategory {
        ...
        return XmbSettingsCategory(vsh,
            ...
            content.addAllV(
                M.settings.system.mkItemOrientation(),
                M.settings.system.mkItemAndroidSystemBar(),
                M.settings.system.mkItemSideMenuNavi(),
                mkItemVshStatusBar(),
                mkItemBtnDisplay(),
                mkItemAnalogSecond(),
